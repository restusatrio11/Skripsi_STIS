...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 768px) {
            ...
            /* Contoh pengaturan lebar input untuk layar yang lebih kecil dari 768px */
            #email {
                width: 100%;
            }
        }
        ...
        <div class="card card1 mx-auto" style="max-width: 600px; background:white; ">
            <div class="row justify-content-center">
                <div class="col-md-6 col-12">
                    ...
                    <div class="row justify-content-center">
                        <img id="logo" src="\images\emailpage.png" class="img-fluid">
                    </div>
                    <h6 class="mb-5 msg-info" style="text-align:justify;">untuk mendapatkan instruksi reset password,
                        silakan
                        masukkan alamat
                        email yang terkait dengan akun simanja Anda</h6>
                    @if (session('status'))
                        <div class="alert alert-success" role="alert">
                            {{ session('status') }}
                        </div>
